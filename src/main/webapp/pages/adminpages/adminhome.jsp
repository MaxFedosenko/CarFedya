      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="/admin" id="offcanvasNavbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Навигация сайта
            </a>
            <ul class="dropdown-menu" aria-labelledby="offcanvasNavbarDropdown">
              <li><a class="dropdown-item" href="admin/carsoperation">Действия с машинами</a></li>
            </ul>
          </li>
        </ul>
      </div>
